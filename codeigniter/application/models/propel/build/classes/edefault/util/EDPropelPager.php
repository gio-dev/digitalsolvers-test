...
class EDPropelPager extends PropelPager
{

    public function __construct($c = null, $peerClass = null, $peerSelectMethod = null, $page = 1, $rowsPerPage = 10000)
    {
    ...
    {
        return \EDefault\Template\Widget::render('admin/propel.pager', array('pager' => $this), true);
    }
