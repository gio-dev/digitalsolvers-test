...
/**
 * Base class that represents a row from the 'respostas' table.
 *
 * 
 *
 * @package    propel.generator.sitedefault.om
 */
abstract class BaseRespostas extends EDBase implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'RespostasPeer';
    ...
    /**
     * The value for the respostas field.
     * @var        string
     */
    protected $respostas;
    ...
    /**
     * Get the [respostas] column value.
     * 
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RespostasPeer::ID;
        }
    ...
    public function setSessionId($v)
    {
        ...
        if ($this->session_id !== $v) {
            $this->session_id = $v;
            $this->modifiedColumns[] = RespostasPeer::SESSION_ID;
        }
    ...
    public function setIp($v)
    {
        ...
        if ($this->ip !== $v) {
            $this->ip = $v;
            $this->modifiedColumns[] = RespostasPeer::IP;
        }
    ...
    /**
     * Set the value of [respostas] column.
     * 
     * @param string $v new value
     * @return Respostas The current object (for fluent API support)
     */
    public function setRespostas($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->respostas !== $v) {
            $this->respostas = $v;
            $this->modifiedColumns[] = RespostasPeer::RESPOSTAS;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RespostasPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = RespostasPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RespostasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RespostasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(RespostasPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(RespostasPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                RespostasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RespostasPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(RespostasPeer::SESSION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`SESSION_ID`';
        }
        if ($this->isColumnModified(RespostasPeer::IP)) {
        ...
        $sql = sprintf(
            'INSERT INTO `respostas` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RespostasPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RespostasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Respostas'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Respostas'][$this->getPrimaryKey()] = true;
        $keys = RespostasPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RespostasPeer::ID)) $criteria->add(RespostasPeer::ID, $this->id);
    ...
    {
        $criteria = new Criteria(RespostasPeer::DATABASE_NAME);
        $criteria->add(RespostasPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Respostas (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Respostas Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RespostasPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RespostasPeer();
        }
    ...
    {
        return (string) $this->exportTo(RespostasPeer::DEFAULT_STRING_FORMAT);
    }
