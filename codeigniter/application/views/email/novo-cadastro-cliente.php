                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p style="color: #636363;font-size: 12px;font-weight: normal;line-height: 20px;font-family: Helvetica, Arial, sans-serif;">
                                                                Você acaba de ser cadastrado no sistema de acompanhamento de obras da <?php echo EMPRESA ?>!
                                                                Os dados e link de acesso serão informados abaixo:
                                                            </p>

                                                            <p style="color: #636363;font-size: 12px;font-weight: normal;line-height: 20px;font-family: Helvetica, Arial, sans-serif;">
                                                                Login: <?php echo $objCliente->getCpfCnpj() ?>
                                                            </p>
                                                            <p style="color: #636363;font-size: 12px;font-weight: normal;line-height: 20px;font-family: Helvetica, Arial, sans-serif;">
                                                                Senha: <?php echo $senhaDesc ?>
                                                            </p>

                                                            <p style="text-align: center">
                                                                <a href="<?php echo base_url_email().'clientes' ?>" style="background-color: #000CFF;border: 1px solid #000CFF;border-radius: 3px;color: #ffffff;display: inline-block;font-family: sans-serif;font-size: 16px;line-height: 44px;text-align: center;text-decoration: none;width: 260px;-webkit-text-size-adjust: none;mso-hide: all" target="_blank" tabindex="-1" rel="external">
                                                                    Link de acesso
                                                                </a>
                                                            </p>
                                                        </td>
