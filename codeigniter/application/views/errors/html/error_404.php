...
if (!function_exists('baseUrlSite404')) {
    function baseUrlSite404($atRoot = FALSE, $atCore = FALSE, $parse = FALSE)
    {
...
<div class="container">
    <div class="left-section">
        <div class="inner-content">
            ...
            <p class="subheading">A página que você buscou não foi encontrada, clique no botão abaixo para voltar para a página inicial.</p>
            <p class="subheading" onclick="homeredirect()" style="
                        text-align: center;
                        padding: 5px 20px;
                        border-radius: 12px;
                        background: #f8f8f8;
...
<script>
    function homeredirect(){
        window.location.href = '<?php echo baseUrlSite404() ?>'
    }
</script>
</body>
</html>